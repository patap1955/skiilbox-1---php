<main class="page-delivery">
  ...
  <section class="page-delivery__info">
    ...
    <ul class="page-delivery__list">
      <li>
        <b class="page-delivery__item-title">Стандартная доставка - <?= $config['cost_delivery']; ?> РУБ / БЕСПЛАТНО (ДЛЯ ЗАКАЗОВ ОТ <?= $config['min_dilevery']; ?> РУБ)</b>
      ...
      <li>
        <b class="page-delivery__item-title">Доставка с примеркой перед покупкой по Москве - <?= $config['cost_delivery']; ?> РУБ / БЕСПЛАТНО (ПРИ ВЫКУПЕ НА СУММУ ОТ <?= $config['min_dilevery']; ?> РУБ)</b>
        <p class="page-delivery__item-desc">
    ...
    <a class="page-delivery__button button" href="<?= $_SERVER['DOCUMENT_ROOT']; ?>/index.php">Продолжить покупки</a>
  </section>
</main>
